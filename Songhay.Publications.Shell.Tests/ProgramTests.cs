...
public class ProgramTests
{
    ...
    public void ShouldAddEntryExtract(params string[] args)
    {
        ...
        args[2] = basePath;
        _testOutputHelper.WriteLine(Program.Run(args));
    }
    ...
    string GetBasePath(string relativePath) => ProgramAssemblyUtility.GetPathFromAssembly(GetType().Assembly, relativePath);
